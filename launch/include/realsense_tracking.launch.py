...
configurable_parameters = [{'name': 'camera_name',                  'default': 'rs_t265', 'description': 'camera unique name'},
                           {'name': 'camera_namespace',             'default': 'rs_t265', 'description': 'namespace for camera'},
                           ...
                           {'name': 'tracking_module.frames_queue_size',            'default': '32', 'description': 'Frame queue length'},
                          ]
